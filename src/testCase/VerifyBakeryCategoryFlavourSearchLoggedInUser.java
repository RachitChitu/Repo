...
public class VerifyBakeryCategoryFlavourSearchLoggedInUser {
	String url;

	@Test(dataProvider = "bakeryCategoryFlavour")
	public void verifyBakeryCategoryFlavourSearchDesktop(String city, String location, String bakery, String bakeryCategoryFlavor,
			String userName, String password, String deliveryType, String paymentMode, String deliveryDate,
			String deliveryTime) {
	...
	public void orderCake(String city, String location,String bakery, String bakeryCategoryFlavor, String userName, String password,
