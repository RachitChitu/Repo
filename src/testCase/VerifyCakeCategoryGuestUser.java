...
public class VerifyCakeCategoryGuestUser {
	String url;

	@Test(dataProvider = "cakeCategory")
	public void verifyCakeCategoryDesktop(String city, String location, String cakeCategory, String userName,
	...
	public void orderCake(String city, String location, String cakeCategory, String userName, String password,
		...
		methods.Generic_Methods.threadSleep(7000);
