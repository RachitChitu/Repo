...
public class VerifyCakeFilterLoggedInUser {
	String url;

	@Test(dataProvider = "cakeFilter")
	public void verifyCakeFilterDesktop(String city, String location, String cakeFilter,String userName, String password, String deliveryType, String paymentMode, String deliveryDate, String deliveryTime) {
		...
		methods.BakeryListingPage.goToCakeTab();
		methods.Generic_Methods.threadSleep(5000);
		utilities.Assertion.verifyProductListingPage(url, city, location);
		methods.CakeCategoryFilter.selectCakeFilter(cakeFilter);
		methods.Generic_Methods.threadSleep(10000);
		utilities.Assertion.verifyCakeFilterPage(url, city, location, cakeFilter);
	}

	@Test(dependsOnMethods="verifyCakeFilterDesktop", dataProvider="cakeFilter")
	public void orderCake(String city, String location, String bakeryFilter,String userName, String password, String deliveryType, String paymentMode, String deliveryDate, String deliveryTime) {
		methods.Generic_Methods.threadSleep(3000);
